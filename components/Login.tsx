        ...
        <div className="p-8 sm:p-12 text-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-linear-to-r from-[var(--gold)] to-[#aa8a22] hover:scale-[1.02] disabled:opacity-50 text-[#060b13] font-black py-5 rounded-3xl transition-all shadow-[0_15px_40px_rgba(212,175,55,0.2)] active:scale-95 flex items-center justify-center gap-4 text-sm uppercase tracking-[0.2em]"
            >
              {isLoading ? (
